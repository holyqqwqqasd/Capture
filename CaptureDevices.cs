...
namespace CamDevices
{
    ...
    public class CapDevice
    {
        ...
        private CapDevice(ushort deviceNumber, string name, string description)
        {
        ...
        public static List<CapDevice> GetDevices()
        {
            ...
            for (ushort i = 0; i < MAX_DEVICES; ++i)
            {
                ...
                {
                    devices.Add(new CapDevice(i, name.ToString(), description.ToString()));
                }
            }
